...
@Autonomous(name = "SoldiersAutonomous_RedGoal ", group = "Drive")
public class SoldiersAutonomous_RedGoal extends Soldiers_Shared {
    ...
    public void runOpMode() {
        ...
        follower.setStartingPose(new Pose(116, 133, Math.toRadians(-143)));
